...
export const agregarColaborador = async (req, res) => {
    ...
    //* El colaborador no debe ser el admin del proyecto
    ...
    //* Revisar que el colaborador no este ya en el proyecto
    ...
    res.json({msg: "Colaborador(a) agregado/a correctamente"});
}
...
export const eliminarColaborador = async (req, res) => {
    ...
    res.json({msg: "Colaborador(a) eliminado/a correctamente"});
}